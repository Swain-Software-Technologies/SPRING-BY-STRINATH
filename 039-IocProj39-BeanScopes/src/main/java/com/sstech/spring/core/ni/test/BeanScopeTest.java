...
//		Get Target Bean Class Object
		...
		System.out.println("============================================");
		info2 = factory.getBean("perInfo",PersonalInfo.class);
		System.out.println(info2);
		System.out.println("============================================");
		
		System.out.println(info.hashCode()+"---------->"+info2.hashCode());
		System.out.println("info==info2 ?"+(info==info2));
